...
const resumeEmail = document.getElementById("resumeEmail") as HTMLHeadingElement;
...
const loadPdfButton = document.getElementById("download-pdf") as HTMLButtonElement;
